...
func main() {
	...
	// sem sinal (somente positivos) ... uint8 uint16, uint32 uint64, utiliza a letra u no inicio para não ter o sinal
	var b byte = 255
	...
	// não existe char no Go, ele reconhece igual o runner que pega a tabela de Unicode (int32)
	char := 'a'
